      ...
      for (i = 0; i < coverage_array.length; i++) {
        ...
        if (coberturaLine !== undefined && coberturaLine !== null) {
          ...
          if (coberturaLine.branch) {
            ...
            reportLines.push('<line branch="' + coberturaLine.branch + '" hits="' + coberturaLine.hits + '" number="' + i + '" condition-coverage="' + condition_coverage + '"><conditions><condition type="jump" number="' + i + '" coverage="' + condition_coverage + '"/></conditions></line>');
          } else {
